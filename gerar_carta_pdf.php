...
if (isset($_POST['dados_grupo'])) {
    ...
    $pdf->Ln(5); // Adiciona espaçamento entre cada pesquisa
    $texto = "Você compareceu recentemente à Fundação HEMOPA para doar Sangue. \n"
    . "Entretanto, a amostra coletada não permitiu a finalização dos exames laboratoriais de triagem, comforme a legislação vigente";
